 ...
 * 注解用于将Web请求映射到请求处理类中的方法，具有灵活的方法签名。
 *
 ...
 * 两者Spring MVC和Spring WebFlux都支持此注解，通过它们各自模块和包结构中的
 * {@code RequestMappingHandlerMapping}和{@code RequestMappingHandlerAdapter}实现。
 * 请参阅下面的参考文档链接，以获取每个模块和包结构中支持的处理方法参数和返回类型的精确列表：
 * <ul>
 * <li>Spring MVC
